...
const Hero = () => {
  return (
    <div className="bg-[url('/slider15.jpg')] bg-cover bg-no-repeat lg:h-[600px] flex items-center justify-start py-10">
             ...
             <div className="flex flex-col gap-5 ">
               ...
               <p className="text-light-color font-bold">Find Jobs, Employment & Career Opportunities</p>
                ...
                <div className="bg-white flex flex-col w-full xl:flex-row gap-5 mt-5 border-[1px] p-[15px] shadow-sm rounded-lg">
                    <div className='flex-1 flex relative border-b-2 xl:border-b-0 xl:border-r-2'>
